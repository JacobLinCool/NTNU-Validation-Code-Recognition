...
class MyModel(tf.keras.Model):
    def __init__(self, dropout_rate):
        ...
        self.cv_p4 = MyConv(512, kernel_size=3, strides=2)   # ( 8,  27,  512)
        self.bn_p4 = MyCSPBottleneck(512, 15)
        self.cv_p5 = MyConv(1024, kernel_size=3, strides=2)  # ( 4,  14, 1024)
        self.bn_p5 = MyCSPBottleneck(1024, 7)
        self.cv_p6 = MyConv(2048, kernel_size=3, strides=2)  # ( 2,   7, 2048)
        self.bn_p6 = MyCSPBottleneck(2048, 7)
        self.cv_p6 = MyConv(4096, kernel_size=3, strides=2)  # ( 1,   4, 4096)
        self.bn_p6 = MyCSPBottleneck(4096, 7)
