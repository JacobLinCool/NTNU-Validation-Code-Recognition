"""
This version tries with another ImageNet, InceptionResNetV2.
And because of the limitation of InceptionResNetV2,
...
class MyModel(tf.keras.Model):
    def __init__(self, dropout_rate):
        ...
        self.img_net  = tf.keras.applications.InceptionResNetV2(
            include_top=True,
            weights=None,
