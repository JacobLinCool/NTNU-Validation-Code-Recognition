...
resized validate code images from (30, 108) to (120, 432).
"""
...
resize_height, resize_width = 120, 432
...
class MyModel(tf.keras.Model):
    def __init__(self, dropout_rate):
        ...
        self.cv_p1 = MyConv(64, kernel_size=3, strides=2)    # (60, 216,   64)
        self.bn_p1 = MyCSPBottleneck(64, 1)
        self.cv_p2 = MyConv(128, kernel_size=3, strides=2)   # (30, 108,  128)
        self.bn_p2 = MyCSPBottleneck(128, 3)
        self.cv_p3 = MyConv(256, kernel_size=3, strides=2)   # (15,  54,  256)
        self.bn_p3 = MyCSPBottleneck(256, 13)
        self.cv_p4 = MyConv(384, kernel_size=3, strides=2)   # ( 8,  27,  384)
        self.bn_p4 = MyCSPBottleneck(384, 13)
        self.cv_p5 = MyConv(512, kernel_size=3, strides=2)   # ( 4,  14,  512)
        self.bn_p5 = MyCSPBottleneck(512, 6)
        self.cv_p6 = MyConv(768, kernel_size=3, strides=2)   # ( 2,   7,  768)
        self.bn_p6 = MyCSPBottleneck(768, 6)
        self.cv_p6 = MyConv(1024, kernel_size=3, strides=2)  # ( 1,   4, 1024)
        self.bn_p6 = MyCSPBottleneck(1024, 6)
...
if __name__ == "__main__":
    ...
    dropout_rate_list  = [  0.97, 0.96, 0.95, 0.94 ]
    bactch_size_list   = [    16 ]
